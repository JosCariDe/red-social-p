...
class GetOnePostByIdUseCase {
  final PostRepository postRepository;

  GetOnePostByIdUseCase({required this.postRepository});

  Future<Either<Failure, Post>> call(int idPost) {
    return postRepository.getOnePostById(idPost);
  }
}
